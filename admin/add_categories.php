...
if(isset($_POST['categorySave'])) {
  ...
  $saveMessage = createcat($con,$cat,$url);
}
?>
				  ...
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="categoryCat" name="categoryCat" placeholder="Category name.." required>							
						</div>

<div class="form-group">
							<label for="title" class="control-label">Category Url (SEO)</label>
							<input type="text" class="form-control" id="categoryUrl" name="categoryUrl"  placeholder="Category URL.." required>							
						</div>						
