					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-2" align="right">
								<a href="add_tags" class="btn btn-default">Add New</a>	
...
echo '<tr>
								...
								<td style="width:200px"><a href="edit_tags-'.$aadi['id'].'" class="btn btn-warning ">Edit</a> &nbsp;&nbsp;<a href="" class="btn btn-danger" onclick="tagdlt('.$aadi['id'].')">Delete</a></td>
...
function tagdlt(e) {
  ...
  var r = confirm("Are you Want Delete this Tag...?");
  if (r == true) {
   $.ajax
      ...
      ({
...

         {
             ...
             window.location.replace("tags.php");
