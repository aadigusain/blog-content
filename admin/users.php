					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-2" align="right">
								<a href="add_users" class="btn btn-default">Add New</a>	
...
echo '<tr>
<td class="text-center"><img src="../'.$aadi['img'].'" width="150" class="img-thumbnail ad-img"></td>
	<td>'.$aadi['name'].'</td>
	
								<td>'.$aadi['about'].'</td>
									
																	
								<td style="width:200px"><a href="edit_users-'.$aadi['id'].'" class="btn btn-warning ">Edit</a> &nbsp;&nbsp;<a href=""  onclick="catdlt('.$aadi['id'].')" class="btn btn-danger">Delete</a></td>
...
function catdlt(e) {
  ...
  var r = confirm("Are you Want Delete this User...?");
  if (r == true) {
