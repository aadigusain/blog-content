...
if(isset($_POST['categorySave'])) {
  ...
  $saveMessage = createsub($con,$cat,$sub,$url);
...
echo $output;
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="categorySub" name="categorySub" value="<?php  if($cat=="Select")
	 {echo $sub; }?>" placeholder="Sub Category name.." required>							
						</div>

<div class="form-group">
							<label for="title" class="control-label">Sub Category Url (SEO)</label>
							<input type="text" class="form-control" id="categoryUrl" name="categoryUrl" value="<?php  if($cat=="Select")
	 { echo $url; }?>" placeholder="Sub Category URL.." required>							
						</div>						
