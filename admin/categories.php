					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-2" align="right">
								<a href="add_categories" class="btn btn-default">Add New</a>	
...
echo '<tr>
	<td>'.$aadi['cat'].'</td>
								...
								<td style="width:200px"><a href="edit_categories-'.$aadi['id'].'" class="btn btn-warning ">Edit</a> &nbsp;&nbsp;<a href="" class="btn btn-danger" onclick="catdlt('.$aadi['id'].')">Delete</a></td>
...
function catdlt(e) {
  ...
  var r = confirm("Are you Want Delete this Category...?");
  if (r == true) {
