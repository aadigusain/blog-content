...
<div class="form-group">
							...
							<textarea rows="4" class="form-control" id="AuthorAbout" name="AuthorAbout"  placeholder="Author About.." required></textarea>							
						</div>
...
<label for="image"  class="span">Choose File....</label>
  <input type="file"  class="custom-file-input hidden" id="image" required accept="image/*">
 ...
 <span id="authorImageChange" class="hidden" >
  ...
  <img src="../img/blog/placeholder_300.jpg" class="img-thumbnail" width="300" id="imagePreview" >
  </div>
   <div class="col-md-6  " >
<div class="edit">
